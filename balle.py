...
class Bullet:
    def __init__(self,game,x,y,size,vector):
        ...
        self.vector=vector
        self.speed=1500
        self.image=pygame.transform.scale(pygame.image.load("platform.png"),self.size)#load this picture in 20*20 pixels
        return
        
    def Tick(self):
        self.x+=self.vector[0]*speed*self.game.fps
        self.y+=self.vector[1]*speed*self.game.fps
